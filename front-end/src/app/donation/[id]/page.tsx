...
import ProfileAvatar from "../_components/userProfile";
    ...
    <div className="absolute flex flex-col items-center justify-center w-full">
      <div className="flex flex-col items-center w-full">
        <div className="w-full h-[319px] flex justify-center items-center">
          {!userProfile?.profile?.backgroundImage &&
          typeof userProfile?.profile?.backgroundImage === "string" ? (
            <Image
            ...
            <div className="w-full h-full bg-cyan-300"></div>
          )}
        </div>
      </div>
      {userProfile ? (
